...
module.exports = {
  ...
  //       fredoka: ["Roboto", "sans-serif"],
  //       jost: ["Jost", "sans-serif"],
  //     },
  //     borderRadius: {
  //       "custom-tl": "274px", // top-left corner
  //       "custom-tr": "30px", // top-right corner
  //       "custom-br": "274px", // bottom-right corner
  //       "custom-bl": "274px", // bottom-left corner
  //     },
  //     // screens: {
  //     //   lg: "1239px",
  //     // },
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        primaryColor: "#001B48",
        // secondaryColor: "#018ABE",
        secondaryColor: "#6E8AF5",
      ...
      // background
      backgroundImage: {
        register: "url('.assest/images/register/register__bg.png')",
      },
      // shdow
      boxShadow: {
