...
export default function LoginForm() {
  ...
  const handleClick = async () => {
    ...
    if (isAllFalse && !emailError) {
      if (password === confirmPassword && name && email && role) {
        const data = {
          name,
          email,
          password,
  ...
  return (
    <>
      <div class="flex justify-center items-center  bg-gray-100 mb-3">
        <div class="w-full max-w-md">
          <div class="flex border-b">
            <button
              className={`w-1/2 py-3 text-center  font-semibold text-gray-700 border-b-4 ${
                role === "Guest" ? "border-blue-500" : "border-transparent"
            ...
            <button
              className={`w-1/2 py-3 text-center  font-semibold text-gray-700 border-b-4 ${
                role === "Moderator" ? "border-green-500" : "border-transparent"
      ...
      {roleError && <span style={{ color: "red" }}>Please Selecte Role</span>}

      {/* <div class="flex justify-center items-center  py-6">
  <div class="w-full max-w-md bg-white shadow-lg rounded-lg">

    <div class="flex">
      <button class="w-1/2 py-3 text-center text-lg font-semibold text-gray-700 border-b-4 border-transparent hover:border-blue-500 focus:border-blue-500 transition duration-300 ease-in-out">
        Student
      </button>
      <button class="w-1/2 py-3 text-center text-lg font-semibold text-gray-700 border-b-4 border-transparent hover:border-green-500 focus:border-green-500 transition duration-300 ease-in-out">
        Teacher
      </button>
    </div>
      ...
      >
        Sign up
          ...
          <Stack direction="column" alignItems="center" spacing={1}>
            ...
            <Box
              onClick={() =>
                window.open(`${config.baseApiUrl}/api/auth/google`)
              }
              sx={{
                width: "100%",
                height: "44px",
