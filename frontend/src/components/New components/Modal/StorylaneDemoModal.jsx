...
import text_speech_image from "src/assets/images/Kids-platforms/text-speech_10439483.png";
import writing_tools_image from "src/assets/images/Kids-platforms/writing-tools_14704289.png";
import medal_image from "src/assets/images/Kids-platforms/medal_15407968.png";
import blogger_image from "src/assets/images/Kids-platforms/blogger_2038774.png";
import audio_book_image from "src/assets/images/Kids-platforms/audio-book_4418685.png";
...
export default function StorylaneDemoModal({ open, handleClose }) {
  const formdata = {
    firstname: "",
    email: "",
    phone: "",
    message: "",
    type: "Request Storylane Demo",
  };
    ...
    try {
      ...
      if (Object.keys(newErrors).length > 0) {
        ...
        if (response.success === true) {
          ...
          setSuccess(true);
          setTimeout(() => {
            window.location.href = "https://www.storylane.in/book-library/";
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start ">
              ...
              <div className="md:w-1/2 space-y-4 text-sm text-gray-700">
                <h2 className="text-2xl md:text-3xl font-bold text-primary">
                  Bring Stories to Life with Storylane
                  <br />
                  <span className="text-secondary">Free Interactive Demo</span>
                </h2>
                <p>Enter your details to explore Storylane's creative tools:</p>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  ...
                  <li className="flex items-center gap-1">
                    <img
                      loading="lazy"
                      src={writing_tools_image}
                      alt={"Easy Writing Tools"}
                      title={"Easy Writing Tools"}
                      className="w-8 h-8"
                    />
                    <strong>Easy Writing Tools</strong>
                  </li>
                  <li className="flex items-center gap-1">
                    <img
                      loading="lazy"
                  ...
                  <li className="flex items-center gap-1">
                    <img
                      loading="lazy"
                      src={blogger_image}
                      alt={"Publish Your Storybook"}
                      title={"Publish Your Storybook"}
                      className="w-8 h-8"
                    />
                    <strong>Publish Your Storybook</strong>
                  </li>
                  <li className="flex items-center gap-1">
                    <img
                      loading="lazy"
                      src={audio_book_image}
                      alt={"Voiceover for Digital Books"}
                      title={"Voiceover for Digital Books"}
                      className="w-8 h-8"
                    />
                    <strong>Voiceover for Digital Books</strong>
                  </li>
                  <li className="flex items-center gap-1">
                    <img
                      loading="lazy"
                      src={Mobile_Learning_Gamification_Solutions_icon}
                      alt={"Create stories in Tamil"}
                      title={"Create stories in Tamil"}
                      className="w-8 h-8"
                    />
                    <strong>Create stories in Tamil</strong>
                  </li>
                </ul>
