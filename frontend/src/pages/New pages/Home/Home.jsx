...
import {
  ...
  zoomVirtualMeeting,
  homeCTA,
  AI_Powered_Course_Management_feature,
  AI_Powered_Quiz,
  ...
  return (
    <div>
      ...
      <div className="bg-transparent">
        ...
        <section>
          <div className="container text-center mt-4 pb-8">
            <MainHeaderText>AI-Powered Course Management</MainHeaderText>
            <HeaderTextMedium>
              Automate, Personalize & Scale Learning for Any Audience
            </HeaderTextMedium>
            <ParagraphText>
              {
                "Whether you’re running an online academy, corporate training program, or professional certification course, our <b>AI-powered LMS digital learning platform</b> makes it simple to launch courses faster, engage learners better, and measure success effortlessly."
              }
            </ParagraphText>
          </div>
          <FeaturesCard data={AI_Powered_Course_Management_feature} row={2} />
        </section>
        <section>
          <div className="container text-center mt-4 ">
            <MainHeaderText>AI-Powered Quiz Creation</MainHeaderText>
            <HeaderTextMedium>
              Build Smarter Assessments in Minutes
            </HeaderTextMedium>
            <ParagraphText>
              {`Create engaging, accurate, and adaptive quizzes with <b>AI-driven
              question bank generators</b>.`}
            </ParagraphText>
            <ParagraphText>
              {`Whether you need <b>K-12 tests, corporate skill assessments</b>, or
              certification exams, our platform automates the entire
              process—saving hours of manual work while ensuring <b>quality,
              variety, and relevance.</b>`}
            </ParagraphText>
          </div>
          <SplitSection data={AI_Powered_Quiz} />
        </section>
        <div>
