...
// import MainImage from "src/assets/images/Apps/Tutor_LMS/heroImage.png";
import FeaturesImage from "src/assets/images/Apps/Tutor_LMS/TutorLMSImage5.png";
  ...
  return (
    <div>
      <Helmet>
        ...
        />
        <link rel="canonical" href={`${BASE_URL}/tutor-web-app`} />
      </Helmet>
      <section className="bg-lightGrey11 dark:bg-lightGrey11-dark flex flex-col lg:flex-row items-center justify-between px-6 md:px-16 lg:px-24 py-16px-6 md:px-16 lg:px-24 py-10">
        ...
        <div className="w-full lg:w-1/2 max-w-xl mb-10 md:mb-0">
          <h1 className="text-4xl md:text-5xl font-bold text-blackColor dark:text-blackColor-dark leading-tight mb-6">
            Launch-Ready Tutoring App - Built for Simplicity, Designed for
            Impact
          </h1>
          <p className="text-lg text-blackColor dark:text-blackColor-dark mb-8">
            This working MVP helps tutors manage exam prep online — from
            assigning papers to marking submissions. Designed to streamline
            small tutoring businesses. Need your own version? We'll customize it
            fast.
          </p>
          <button
            onClick={() =>
              window.open("https://tutors.atlearnlms.com/", "_blank")
            }
