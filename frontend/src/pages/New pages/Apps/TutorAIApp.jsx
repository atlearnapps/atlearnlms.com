...
import MainImage from "src/assets/images/Apps/Tutor_AI/TutorAIImage1.png";
...
import {
  ...
  frd,
  moreApps,
} from "src/Page_Content/App/Tutor_AI";
import FeaturesImage from "src/assets/images/Apps/Tutor_AI/TutorAIImage3.png";
import CTASection from "src/components/New components/CTASection";
import {
  Tutors_Web_App_bottom_CTA,
  Tutors_Web_App_CTA,
} from "src/Page_Content/App/Tutors_Web_App";
  ...
  return (
    <div>
      <Helmet>
        ...
        />
        <link rel="canonical" href={`${BASE_URL}/tutor-ai-app`} />
      </Helmet>
      <section className="bg-lightGrey11 dark:bg-lightGrey11-dark flex flex-col lg:flex-row items-center justify-between px-6 md:px-16 lg:px-24 py-16px-6 md:px-16 lg:px-24 py-10">
        ...
        <div className="w-full lg:w-1/2 max-w-xl mb-10 md:mb-0">
          ...
          <p className="text-lg text-blackColor dark:text-blackColor-dark mb-8">
            TutorAI is an AI-powered education platform that delivers a
            personalized and interactive learning journey across subjects like
            Physics, Mathematics, and Chemistry. With a sleek dashboard,
            real-time AI tutoring, structured lessons, quizzes, and progress
            tracking, TutorAI ensures a modern, engaging, and student-friendly
            experience while supporting dedicated flows for students, parents,
            and teachers.
          </p>
          <button
            onClick={() =>
              window.open("https://tutor-ai.atlearnlms.com/", "_blank")
            }
      ...
      <section>
        <CTASection data={Tutors_Web_App_CTA} />
      </section>
      <section>
      ...
      <section>
        <CTASection data={Tutors_Web_App_bottom_CTA} />
      </section>
    </div>
  );
}

export default TutorAIApp;
