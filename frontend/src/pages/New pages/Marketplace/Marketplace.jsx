...
import { atlearnFeatures, atlearnFeaturesCards, TeachingBenefits, TeachingBenefitsFeatures } from "src/Page_Content/Marketplace";
...
function Marketplace() {
  return (
    <div>
          ...
          <div className="container 2xl:container-secondary-md relative overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
              ...
              <div data-aos="fade-up">
                ...
                <div>
                  <PrimaryButton primary={true}>View Courses</PrimaryButton>
      ...
      <div>
        <SectionHeading data={atlearnFeatures} />
        <FeaturesCard data={atlearnFeaturesCards} row={3} />
      </div>

      <div>
        <SectionHeading data={TeachingBenefits} />
        <FeaturesCard data={TeachingBenefitsFeatures} row={3} />
      </div>
                ...
                <div className="tab-content-wrapper sm:px-15px mb-30px">
                  <div className="p-15px bg-whiteColor shadow-brand dark:bg-darkdeep3-dark dark:shadow-brand-dark">
                    ...
                    <div>
                      ...
                      <div
                        className="text-xl font-semibold text-blackColor mb-10px font-hind dark:text-blackColor-dark hover:text-primary-color dark:hover:text-primaryColor"
                      >
      ...
      <section>
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-30px pb-30px">
            {/* about left */}
            <div data-aos="fade-up">
              <span className="text-size-15 font-semibold text-secondaryColor inline-block uppercase mb-[13px] mt-30px lg:mt-0">
                EDUCATION SOLUTION
              </span>
              <h3 className="text-3xl md:text-size-35 lg:text-size-42 2xl:text-size-47 leading-10 md:leading-2xl font-bold text-blackColor dark:text-blackColor-dark mb-3">
                Why Teach With us
              </h3>
              <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark mb-6 pl-3 border-l-2 border-primaryColor">
                25+Contrary to popular belief, Lorem Ipsum is not simply random
            ...
            <div className="overflow-visible" data-aos="fade-up">
              <div className="tilt">
                <img
                  src="./assets/images/about/about_online_store.png"
                  alt=""
                  className="w-full"
                />
              </div>
      ...
      <section className="py-50px pb-20">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-30px mb-65px">
            <div className="lg:col-star-1 lg:col-span-12">
              <span
