  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2   cursor-pointer text-size-12 2xl:text-size-15 px-15px py-2 text-whiteColor bg-secondaryColor2 block border border-secondaryColor2 rounded-standard font-semibold mr-[7px] 2xl:mr-15px hover:scale-105 transition-transform"
      >
        Unlock Free Demo
      </button>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start ">
              ...
              <div className="md:w-1/2 space-y-4 text-sm text-gray-700">
                <h2 className="text-2xl md:text-3xl font-bold text-primary">
                  Experience Our Virtual Meeting
                  <br/>
                  <span className="text-secondary">Free Instant Demo</span>
                </h2>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  ...
                  <li className="flex items-center gap-1">
                    <img
                      loading="lazy"
                      src={share_room_access_icon}
                      alt={"Screen Sharing"}
                      title={"Screen Sharing"}
                      className="w-8 h-8"
                    />
                    <strong>Share Room Access</strong>
                  </li>
                  <li className="flex items-center gap-1">
                    <img
                      loading="lazy"
                      src={multi_user_dashboard_icon}
                      alt={"Multi-user dashboard"}
                      title={"Multi-user dashboard"}
                      className="w-8 h-8"
                    />
                    <strong>Multi-user dashboard</strong>
                  </li>
                  <li className="flex items-center gap-1">
                    <img
                      loading="lazy"
